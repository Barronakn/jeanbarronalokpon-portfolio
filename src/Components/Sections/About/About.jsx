...
const About = () => {
  return (
    <section id="about" className="bg-purple-sky pt-10">
        ...
        <div data-aos="fade-left" className="xl:w-3/6">
          <div>
            ...
            <p className="text-base md:text-lg text-white">
              Développeur Web junior autodidacte passionné par la création de
              sites conviviales, je possède une solide expérience dans les
              langages de programmation, ainsi que dans les frameworks. Je suis
              convaincu que la collaboration est la clé du succès dans le
              développement de projets Web complexes.
            </p>
          </div>
          <ul className="list my-10 relative px-8 z-10 before:absolute before:top-0 before:bottom-0 before:left-2 before:m-auto before:w-1 before:bg-black before:-z-10 before:h-5/6 text-white">
            <li>
              <span className="font-bold text-xs sm:text-base">Habite à :</span>{" "}
              <span className="text-xs sm:text-base">Abomey-Calavi, Bénin</span>
            </li>
            <li>
              ...
              <span className="text-xs sm:text-base">
                Musique | Lecture | Jeux | Sport
              </span>
            </li>
            <li>
              <span className="font-bold text-xs sm:text-base">Genre :</span>{" "}
              <span className="text-xs sm:text-base">Masculin</span>
            </li>
            <li>
